  ...
  const slides = [
    {
      ...
      content: (
        <div className="space-y-4 font-mono text-xs">
          <div className="p-4 bg-[#05070a] border border-[#181f2e] rounded-sm">
            <h4 className="text-[#00f0ff] font-syne font-bold text-sm mb-1 uppercase">THE NTRO MANDATE</h4>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 text-center">
            <div className="p-3 bg-[#05070a] border border-[#181f2e] rounded-sm">
              <span className="text-[#00f0ff] font-syne font-bold block text-sm">1. FIND</span>
              <span className="text-[#64748b] text-[10px]">Uncover flaws across 7 pillars</span>
            </div>
            <div className="p-3 bg-[#05070a] border border-[#181f2e] rounded-sm">
              <span className="text-[#00f0ff] font-syne font-bold block text-sm">2. EXPLAIN</span>
              <span className="text-[#64748b] text-[10px]">Quantify impact via CVSS 3.1</span>
            </div>
            <div className="p-3 bg-[#05070a] border border-[#181f2e] rounded-sm">
              <span className="text-[#00f0ff] font-syne font-bold block text-sm">3. PROVE</span>
              <span className="text-[#64748b] text-[10px]">Safe, controlled PoC tests</span>
            </div>
            <div className="p-3 bg-[#05070a] border border-[#181f2e] rounded-sm">
              <span className="text-[#00f0ff] font-syne font-bold block text-sm">4. RECOMMEND</span>
              <span className="text-[#64748b] text-[10px]">Concrete remediation guide</span>
            </div>
          </div>
        </div>
      )
    },
    {
      ...
      content: (
        <div className="space-y-4 font-mono text-xs">
          <div className="p-4 bg-[#05070a] border border-[#00f0ff]/30 rounded-sm">
            <h4 className="text-[#00ff9d] font-syne font-bold text-sm mb-2">HOW TO EXPLAIN TO NON-TECHNICAL JUDGES:</h4>
            <blockquote className="border-l-2 border-[#00f0ff] pl-3 italic text-white/90 leading-relaxed">
    ...
    },
    {
      ...
      content: (
        <div className="space-y-3 font-mono text-xs">
          <div className="p-3 bg-[#05070a] border border-[#181f2e] rounded-sm">
            <strong className="text-[#00f0ff] font-syne block text-xs">1. Human-in-the-Loop Triage</strong>
          ...
          <div className="p-3 bg-[#05070a] border border-[#181f2e] rounded-sm">
            <strong className="text-[#00f0ff] font-syne block text-xs">2. Safe-Mode 127.0.0.1 Sinkhole</strong>
            <p className="text-[#94a3b8] text-[11px] mt-1">
          ...
          <div className="p-3 bg-[#05070a] border border-[#181f2e] rounded-sm">
            <strong className="text-[#00f0ff] font-syne block text-xs">3. DPDP Act 2023 Statutory Compliance</strong>
            <p className="text-[#94a3b8] text-[11px] mt-1">
    ...
    <div className="space-y-6 animate-fade-in pb-12 font-mono">
      ...
      <div className="border-b border-[#181f2e] pb-4">
        ...
        <h2 className="font-syne font-extrabold text-3xl text-white tracking-tight mt-1">
          Judge pitch & <em className="text-[#00f0ff] not-italic font-semibold">defense</em>
        </h2>
      ...
      {/* Slide Carousel */}
      <div className="border border-[#181f2e] bg-gradient-to-br from-[#0c0e14] to-[#07080c] p-6 rounded-sm shadow-xl space-y-4">
        <div className="flex items-center justify-between border-b border-[#181f2e] pb-3">
          <div>
            ...
            <span className="text-[11px] text-[#00f0ff]">{slides[currentSlide].subtitle}</span>
          </div>
          ...
          <div className="flex items-center space-x-2">
            <button
              ...
              className="p-1.5 rounded bg-[#05070a] border border-[#181f2e] text-[#94a3b8] hover:text-white disabled:opacity-40 transition-colors"
            >
      ...
      <div className="border border-[#181f2e] bg-gradient-to-br from-[#0c0e14] to-[#07080c] p-6 rounded-sm space-y-4">
        <div className="flex items-center space-x-2 text-xs text-[#00f0ff] uppercase font-syne font-bold">
        ...
        <div className="space-y-3">
          {qnaList.map((item, idx) => (
            <div key={idx} className="p-4 bg-[#05070a] border border-[#181f2e] rounded-sm space-y-1.5">
              <strong className="text-xs text-[#ffb703] font-syne font-semibold block">{item.q}</strong>
              <p className="text-xs text-[#94a3b8] leading-relaxed m-0 font-mono">{item.a}</p>
            </div>
          ))}
        </div>
      </div>
